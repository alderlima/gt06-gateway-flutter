    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Row(
          ...
          children: [
            const Text('GT06 TRACKER PRO', style: TextStyle(fontWeight: FontWeight.bold, letterSpacing: 1.2)),
            if (appInBackground)
              Container(
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Text("CONSOLE LOGS", style: TextStyle(color: Colors.cyan, fontSize: 11, fontWeight: FontWeight.bold)),
                      const Spacer(),
                      Text(
